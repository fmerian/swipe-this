...
- **Google Fonts Support** `Pro`: We now support more fonts with [Google Fonts](https://fonts.google.com/). When customizing your CSS files, you specify the fonts that fits your brand best — Example below. Learn more about Custom CSS [here](https://mintlify.com/docs/advanced/custom/css).
```
.roboto-regular {
...
``` 
- **New UI Components**: Advanced footer, line-highligting, banner. Learn more about Components [here](https://mintlify.com/docs/content/components/accordions).

**Improvements 💎**

- **Speed Improvements**: OpenAPI pages & update workflow.

**Experiment 🧰**

- **Web Editor V2**: We're currently exploring options to enhance the experience of the Web Editor. Among them: an image uploader and a WYSIWYG experience.
...
<AccordionGroup>
  <Accordion title="Themes" description="Customizations to make your content stand out">
  ...
  <Accordion title="OpenAPI Automations">
...
<AccordionGroup>
  ...
  <Accordion title="Open Source MDX Engine">
  ...
  <Accordion title="Chat Analytics">
...
<AccordionGroup>
  <Accordion title="CLI Enhancements">
  ...
  <Accordion title="API Playground Redesign">
