...
<AccordionGroup>
  ...
  <Accordion title="OpenAPI Automations">
    When you're constantly shipping changes to your API, it's important to reflect those changes in your documentation ASAP. Our revamped setup makes autogenerating your API Reference docs seamless, removing the need for any manual labor to reflect changes in production.
  </Accordion>
</AccordionGroup>
...
<Tip>
  To upgrade your CLI, run `npm i mintlify@latest -g`
</Tip>
