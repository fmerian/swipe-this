...
- **Search Layout**: 
- ** Anchor Links**: We updated the anchor generation code to support more edge cases.
- **API Playground UI**: We fixed a UI bug on the API Playground when switching tabs.
- **Sidebar UX**: We also squashed a bug with sidebar items.

**Experiment 🧰**

- **Web Editor V2**: We're currently exploring options to enhance the experience of the Web Editor. Among them are an image uploader and a WYSIWYG experience.
