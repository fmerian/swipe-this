...
import MySnippet from '/snippets/path/to/snippet-example.mdx';
...
- **Speed Improvements**: We made many updates to improve the overall speed for your OpenAPI pages and update workflows.
